...
<div id="tab-tamizaje" class="tab-content" style="display: none;">
  <div class="control-section">
    ...
    <!-- Información de Fecha Límite (estilo unificado) -->
    <div style="margin-top: 16px; padding: 10px 14px; background: #eef2ff; border-radius: 10px; border-left: 4px solid #3b82f6; display: flex; align-items: center; gap: 10px;">
      ...
      <div>
        <div style="font-size: 12px; font-weight: 600; color: #2563eb; text-transform: uppercase; letter-spacing: 0.05em;">Fecha Límite</div>
        <div style="font-size: 13px; font-weight: 600; color: #0f172a;" id="tamizaje-fecha-limite">-</div>
      </div>
    </div>
        ...
        <tbody>
          ...
          <tr style="border-bottom: 1px solid #e5e7eb;">
            ...
            <td style="padding: 12px; text-align: center;">
              <button class="btn-registrar" onclick="abrirModalTamizaje()" data-control-id="" id="btn-tamizaje-1">
          ...
          <tr style="border-bottom: 1px solid #e5e7eb;">
            ...
            <td style="padding: 12px;"><span class="estado-badge estado-seguimiento">-</span></td>
            <td style="padding: 12px; text-align: center;">
              <button class="btn-registrar" onclick="abrirModalTamizaje()" data-control-id="" id="btn-tamizaje-galen">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="btn-icon">
                  <path d="M5 12h14"></path>
                  <path d="M12 5v14"></path>
                </svg>
    ...
    <div style="margin-top: 24px; padding: 20px; background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border-radius: 12px; border: 1px solid #bae6fd;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-top: 16px;">
        <div style="padding: 16px; background: white; border-radius: 8px; border-left: 4px solid #10b981;">
          <div style="font-size: 12px; color: #64748b; margin-bottom: 4px;">Tamizaje Completado</div>
          <div style="font-size: 18px; font-weight: 700; color: #10b981;" id="cumple-tamizaje-total">-</div>
          <div style="font-size: 11px; color: #64748b; margin-top: 4px;">Tamizajes realizados dentro del plazo</div>
        </div>
        <div style="padding: 16px; background: white; border-radius: 8px; border-left: 4px solid #f59e0b;">
          ...
          <div style="font-size: 18px; font-weight: 700; color: #f59e0b;" id="seguimiento-tamizaje">-</div>
          <div style="font-size: 11px; color: #64748b; margin-top: 4px;">Tamizajes pendientes de registro</div>
        </div>
        <div style="padding: 16px; background: white; border-radius: 8px; border-left: 4px solid #ef4444;">
          ...
          <div style="font-size: 18px; font-weight: 700; color: #ef4444;" id="no-cumple-tamizaje">-</div>
          <div style="font-size: 11px; color: #64748b; margin-top: 4px;">Tamizajes fuera del plazo establecido</div>
        </div>
      </div>
      <div style="margin-top: 16px; padding: 12px; background: white; border-radius: 8px;">
        ...
        <div style="font-size: 18px; font-weight: 700;">
          <span class="estado-badge estado-seguimiento" id="estado-general-tamizaje">SEGUIMIENTO</span>
        </div>
      </div>
    </div>
  </div>
